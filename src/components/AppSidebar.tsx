...
import { Home, Building2, Kanban, FileText, ChevronLeft, ChevronRight, Calendar, Puzzle, Zap, Video, MessageCircle } from "lucide-react";
...
const navItems = [
  ...
  { icon: MessageCircle, label: "Mensagens", path: "/messages", comingSoon: false },
